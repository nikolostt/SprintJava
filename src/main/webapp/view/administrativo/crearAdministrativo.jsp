...
<head>
   ...
   <title>crearAdministrativo</title>
</head>
...
<body>
	...
	<form action="${pageContext.request.contextPath}/CrearAdministrativo" method="post" class="form col-6">
	
	
	
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">Nombre de usuario</label>
			<input type="text" class="form-control" id="exampleInputEmail1" name="nombreUsuario" value="${administrativo.getNombreUsuario()}"  aria-describedby="emailHelp">
			<div id="emailHelp" class="form-text"></div>
		</div>
		
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">Fecha de nacimiento</label>
			<input type="date" class="form-control" id="exampleInputEmail1" name="fechaNacimiento" value="${administrativo.getFechaNacimiento()}" aria-describedby="emailHelp">
			<div id="emailHelp" class="form-text"></div>
		</div>
		
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">RUN</label>
			<input type="number" class="form-control" id="exampleInputEmail1" name="run"  value="${administrativo.getRun()}" aria-describedby="emailHelp">
			<div id="emailHelp" class="form-text-color=white">Ingrese RUN sin puntos, ni guión, ni dígito verificador.</div>
		</div>
		
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">Contraseña</label>
			<input type="text" class="form-control" id="exampleInputEmail1" name="clave" value="${administrativo.getClave()}" aria-describedby="emailHelp">
			<div id="emailHelp" class="form-text"></div>
		</div>
